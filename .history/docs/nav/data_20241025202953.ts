...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'https://s1.vip.wpscdn.cn/web-libs/image/favicon/learning.png',
        title: 'WPS 学堂',
        desc: 'WPS表格函数学习',
      ...
      {
        icon: 'https://hitokoto.cn/favicon.ico?t=1527937218382',
        title: 'Hitokoto-一言',
        desc: '每日一言',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://common-bucket.zhaopin.cn/img/favicon/favicon-2011.ico',
        title: '智联招聘',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://www.maotouyingcc.com/wp-content/uploads/2021/10/01.png',
        title: '猫头鹰源码',
        link: 'https://www.maotouyingcc.com/',
      },
      {
        //icon: 'https://www.maotouyingcc.com/wp-content/uploads/2021/10/01.png',
        title: '编程导航-鱼皮',
      ...
      {
        icon: 'https://static.iocoder.cn/ruoyi-vue-pro-logo.png',
        title: 'yudao开发指南',
        link: 'https://cloud.iocoder.cn/intro/',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://igoutu.cn/vue-static/icon/favicon/icons8_fav_32%C3%9732.png',
        title: 'ICONS',
        desc: '软件网页icons',
